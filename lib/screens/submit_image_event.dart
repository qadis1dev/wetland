...
class SubmitImageEvent extends StatefulWidget {
  const SubmitImageEvent({super.key, required this.id, required this.parentTitle});

  final String id;
  final String parentTitle;
  @override
  State<SubmitImageEvent> createState() => _SubmitImageEventState();
}

class _SubmitImageEventState extends State<SubmitImageEvent> {
