...
class SubmitImageWetland extends StatefulWidget {
  const SubmitImageWetland({super.key, required this.id, required this.parentTitle});

  final String id;
  final String parentTitle;
  @override
  State<SubmitImageWetland> createState() => _SubmitImageWetlandState();
}

class _SubmitImageWetlandState extends State<SubmitImageWetland> {
