...
class AddWetlandImage extends StatefulWidget {
  const AddWetlandImage({super.key, required this.id});

  final String id;
  @override
  State<AddWetlandImage> createState() => _AddWetlandImageState();
}

class _AddWetlandImageState extends State<AddWetlandImage> {
  ...
  Future uploadImage() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection("wetlands").doc(widget.id).collection("images").add({
